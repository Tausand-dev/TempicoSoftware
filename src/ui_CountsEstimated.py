...
class Ui_CountsEstimated(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.comboBoxTimeRange.setItemText(1, QCoreApplication.translate("Form", u"30 seconds", None))
        self.comboBoxTimeRange.setItemText(2, QCoreApplication.translate("Form", u"1 minute", None))
        self.comboBoxTimeRange.setItemText(3, QCoreApplication.translate("Form", u"5 minute", None))
        self.comboBoxTimeRange.setItemText(4, QCoreApplication.translate("Form", u"10 minute", None))
