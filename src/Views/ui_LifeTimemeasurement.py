...
class UiLifeTime(object):
    def setupUi(self, Form):
        ...
        self.ConfigurationRunParameters.setFrameShadow(QFrame.Plain)
        ...
        self.configurationParameters.setFrameShape(QFrame.StyledPanel)
        self.configurationParameters.setFrameShadow(QFrame.Plain)
        ...
        self.runParameters.setFrameShape(QFrame.StyledPanel)
        self.runParameters.setFrameShadow(QFrame.Plain)
        ...
        self.fitFunctionFrame.setFrameShape(QFrame.StyledPanel)
        self.fitFunctionFrame.setFrameShadow(QFrame.Plain)
        ...
        self.functionFrame.setFrameShape(QFrame.NoFrame)
        ...
        self.equationFrame.setFrameShape(QFrame.NoFrame)
        ...
        self.fitParametersFrame.setFrameShape(QFrame.StyledPanel)
        self.fitParametersFrame.setFrameShadow(QFrame.Plain)
