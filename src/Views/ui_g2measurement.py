...
class Ui_G2(object):
    def setupUi(self, G2):
        ...
        G2.resize(904, 735)
        G2.setAutoFillBackground(False)
        ...
        self.GraphicStatusFrame.setAutoFillBackground(False)
        ...
        self.ParametersMeasurementFrame.setAutoFillBackground(True)
        ...
        self.SettingsFitFrame.setAutoFillBackground(False)
        ...
        self.ApplyFitFrame.setAutoFillBackground(True)
