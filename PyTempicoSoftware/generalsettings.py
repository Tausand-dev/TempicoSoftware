...
class GeneralSettingsWindow(QDialog):
    def __init__(self):
        ...
        self.Comboboxthresholdvoltage.addItems(["0.9 V","1 V","1.1 V","1.2 V","1.3 V","1.4 V","1.5 V","1.6 V"])
        self.Comboboxthresholdvoltage.setGeometry(180,10,50,20)
        ...
        button.setGeometry(140, 80, 100, 40)
