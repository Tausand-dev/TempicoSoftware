...
from PySide2.QtWidgets import QHBoxLayout, QWidget, QVBoxLayout, QFrame, QLabel, QComboBox, QCheckBox, QSpinBox, QPushButton, QGridLayout, QMainWindow, QApplication
